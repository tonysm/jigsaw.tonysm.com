    ...
    <div class="leading-relaxed">
        ...
        <div class="max-w-2xl mx-auto content space-y-16 py-10 md:pt-36">
            ...
            <section class="space-y-4">
                ...
                <p>As part-time DevOps person, I many deploying and configuring local development environments on a lot
                    of different projects. We had a lot different projects there, so I had to learn a bunch of different
                ...
                <p>And before that, I worked as a Back-end Engineer at Gabstr, a location-based social network. Built
                    the APIs we used and a geo-location based content platform on top of Redis and PostGIS.</p>
            </section>
